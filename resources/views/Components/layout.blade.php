        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              {{-- <x-nav-link href="/contact" :active="request()->is('contact')" type="butten">Contact</x-nav-link> --}} {{-- [تكليف 5] --}}
            </div>
          </div>
        </div>
        <div class="hidden md:block">
...
{{--   <?php echo $slot; ?> [This will render the content passed to the layout component] --}} 
  {{-- {{ $slot }}  [This will render the content passed to the layout component] [استدعاءالنص من العنصر] --}}
